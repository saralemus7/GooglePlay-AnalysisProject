...
Reviews is definitely one of our most skewed predictors, as shown by the strong right skew in this histogram. Originally, the skew was even more extreme due to the presence of outliers. We removed 38 outliers using the 1.5 x (IQR) to the third/first quartile rule. Examples of apps that were removed are extremely popular apps such as "Facebook" or "Snapchat." This would mean that later our model will not be extrapolating to apps with greater than 203579 reviews. 
