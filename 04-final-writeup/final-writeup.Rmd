...
In conclusion, our project’s goal was to understand what factors contribute to an apps success as measured by the average rating given to an application. By conducting multiple regression analysis, we found that the categories and size variables are vital to the outcome of the mean ratings for an application. This can be useful to app developers, users, and application stores in how to view, change, and utilize applications. 
