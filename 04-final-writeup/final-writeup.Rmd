...
Given the above plot, the most common content rating is "Everyone" within the dataset. The next most occurring category is Teen. After that, we see even less apps that are rated mature. Unrated and Adults only have so few observations that they are hard to see on the plot.
